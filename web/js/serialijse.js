(function (exports) {
    ...
    function serialize(object) {
        ...
        if(object === undefined)throw("serialize: expect a valid object to serialize ");
        ...
        function find_object(obj) {
            if (obj.____index !== undefined) {
                if(objects[obj.____index] === obj)throw('');
    ...
    function deserialize(serializationString) {
        ...
        function deserialize_node(node) {
            ...
            if (node.hasOwnProperty("d")) {
                ...
                if(cache[object_id] !== cache_object)throw('');
                return  cache_object;
        ...
        function _deserialize_object(object_definition, object_id) {
            ...
            if(!object_definition.c)throw('');
            if(!object_definition.d)throw('');
            ...
            if (className === "Object") {
                ...
                if(isFunction(constructor))throw('');
                obj = new constructor();
            }
